...
var NAMESPACE = 'stencil-state-store';
...
var scheduleUpdate = function (elm, hostRef, cmpMeta, isInitialLoad) {
    ...
    if (isInitialLoad) {
        ...
        if (hostRef.$queuedListeners$) {
            hostRef.$queuedListeners$.forEach(function (_b) {
...
var addEventListeners = function (elm, hostRef, listeners) {
    ...
    var removeFns = listeners.map(function (_b) {
...
var connectedCallback = function (elm, cmpMeta) {
    if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
        ...
        if (!(hostRef_2.$flags$ & 1 /* hasConnected */)) {
            ...
            if (cmpMeta.$members$) {
                Object.entries(cmpMeta.$members$).forEach(function (_b) {
                    var memberName = _b[0], memberFlags = _b[1][0];
